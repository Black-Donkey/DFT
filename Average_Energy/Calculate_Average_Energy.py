...
U2_N4_OV0_path = "S:/projects/15_LLTO_U2_N3_OV0/data_energy.csv"
...
# LLTO_U2_N4_OV0
U2_N4_OV0_count = [2, 32, 13, 16, 3, 1, 2, 4, 16, 5, 2, 3, 4, 1, 2]
U2_N4_OV0_energy = sum(pd.read_csv(U2_N4_OV0_path, header=None, nrows=len(U2_N4_OV0_count)).values.tolist(), [])

U2_N4_OV0_energy_min_idx = U2_N4_OV0_energy.index(min(U2_N4_OV0_energy))
U2_N4_OV0_energy_delta = [i - U2_N4_OV0_energy[U2_N4_OV0_energy_min_idx] for i in U2_N4_OV0_energy]

Z = 0
for idx in range(0, len(U2_N4_OV0_energy_delta)):
    Z += U2_N4_OV0_count[idx] * np.exp(-U2_N4_OV0_energy_delta[idx] / (kb * T))
sum_term = 0
for idx in range(0, len(U2_N4_OV0_energy_delta)):
    sum_term += U2_N4_OV0_energy[idx] * U2_N4_OV0_count[idx] * np.exp(-U2_N4_OV0_energy_delta[idx] / (kb * T))
U2_N4_OV0_average_energy = sum_term / Z
print(U2_N4_OV0_average_energy)
